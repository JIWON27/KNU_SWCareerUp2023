...
import com.example.blog.web.dto.AddArticleRequestDto;
import com.example.blog.web.dto.ArticleResponseDto;
import com.example.blog.web.dto.UpdateArticleRequestDto;
...
public class BlogAPIController {
  ...
  public ResponseEntity<List<ArticleResponseDto>> findAllArticles() {
    // blogService.findAll(); -> 여기서 리턴되는가 Article 리스트니 이걸 reponsedto로 변환해줘야함.
